...
selects either version. If the DLAMI only exposes Python 3.12 and `uv` is
installed, the wrapper installs a separate UV-managed Python 3.11. It does not
modify `/opt/aws_neuronx_venv_pytorch_2_9`.
